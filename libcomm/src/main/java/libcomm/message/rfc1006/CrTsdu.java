...
/**
 * Representa el TSDU de un telegrada de solicitud de conexión o <i>Connection
 * Request</i>. Contiene los bytes sin decodificar que forman un telegrama de
 ...
 * @version 1.0
 */
public class CrTsdu implements ITsdu {
	 ...
	 *            <code>CrTsdu</code>.
	 */
	public CrTsdu (final byte[] bytes) {
