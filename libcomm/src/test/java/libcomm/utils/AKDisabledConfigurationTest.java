 ...
 * @version 1.0
 */
class AKDisabledConfigurationTest {
	...
	AKDisabledConfigurationTest(final String name, final ConnectionMode mode) {
		this.name = name;
	...
	private Properties getCommonProperties(final ConnectionMode mode) {
		...
		prop.setProperty(ConnectionProperties.KEY_CONNECTION_AK_ENABLED, "false");
