...
/**
 * Tests de transmisión de mensaje ST en ambos sentidos. 
 * <p>
 * 17/03/2016 20:20:25
 * </p>
 ...
 * @version 1.0
 */
public class TransmissionSTTest extends AbstractTransmissionTest {

	public TransmissionSTTest() throws CommunicationException {
		super (
			TransmissionSTTest.class,
			new CommTest("ST-server", ConnectionMode.SERVER),
			new CommTest("ST-client", ConnectionMode.CLIENT)
		);
	}
